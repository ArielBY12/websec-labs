...
module.exports = {
  ...
  defense: 'Rejects global / globalThis / this / process.',
  ...
  createRouter(ctx) {
    ...
    r.post('/render', (req, res) => {
      ...
      if (/global|globalThis|this|process/i.test(tpl))   //! a longer word blacklist — still bypassable via the constructor→Function chain reaching global scope
